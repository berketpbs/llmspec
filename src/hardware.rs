...
/// the probe lands at about 60% of the rated figure — 53 GB/s on DDR5-5600
/// rated at 89.6 — and the CPU efficiency is fitted against what the probe
/// reports. A dual-channel DDR4-3200 machine rates at 51 GB/s, so its probe
/// reads around 30. Measured CPU and hybrid decode on machines whose memory
/// was not measured lands closest at 30; the 60 this used to be promised
/// CPU-only laptops three times the speed they reach.
